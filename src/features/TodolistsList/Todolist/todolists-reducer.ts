...
export type changeTodolistsEntityStatusActionType = ReturnType<
  typeof changeTodolistsEntityStatusAC
>;
// actions
...
export const changeTodolistsEntityStatusAC = (
  todolistId: string,
  entityStatus: RequestStatusType
...
export const addTodolistTC =
  (title: string) => (dispatch: Dispatch<ActionType>) => {
    dispatch(setStatusAC("loading"));
    todolistAPI
